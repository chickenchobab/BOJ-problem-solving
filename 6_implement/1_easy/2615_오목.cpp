...
bool connected(int i, int j, int ni, int nj){
    ...
    for (int j = 1; j <= 19 && winner == 0; j ++){
        for (int i = 1; i <= 19 && winner == 0; i ++){
            ...
            for (int d = 0; d < 8; d ++){
                ...
                if (!connected(i, j, ni, nj)) continue;
                if (connected(i, j, pi, pj)) continue;
                dfs(i, j, ni, nj, d, 1);
            }
        }
    }
